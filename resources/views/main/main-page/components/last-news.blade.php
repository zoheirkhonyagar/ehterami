                ...
                <div class="range range-center range-30 range-flex">
                    <div class="cell-sm-12 cell-lg-4">
                        <article class="post-modern">
                            <a class="post-modern__image-wrap" href="single-post.html"><img class="post-modern__image" src="images/post-1-365x215.jpg" alt="" width="764" height="215"></a>
                            <div class="post-modern__main">
                                ...
                                <ul class="post-modern__meta">
                                    <li><span class="icon icon-primary mdi mdi-clock"></span><a href="single-post.html">۶ فروردین ۱۳۹۷</a></li>
                                    <li><span class="icon icon-primary fl-justicons-visible6"></span><span>۵۲۴</span></li>
                                    <li> <span class="icon icon-primary mdi mdi-comment-outline"></span><a href="single-post.html">۳</a></li>
                                </ul>
                            </div>
                        </article>
                    </div>
