                        ...
                        <div class="range range-sm-bottom range-20">
                            <div class="cell-sm-6">
                                <div class="form-wrap">
                                    ...
                                    <label class="form-label" for="contact-first-name">نام</label>
                                </div>
                            </div>
                            <div class="cell-sm-6">
                                <div class="form-wrap">
                            ...
                            <div class="cell-sm-6">
                                <div class="form-wrap">
                                    <input class="form-input" id="contact-email" type="email" name="email" data-constraints="@Email @Required" dir="ltr">
